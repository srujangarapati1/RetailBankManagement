...
<br><br><br>
<div class="container">
<a href="<%=request.getContextPath() %>/executiveController?action=customer"><button class="btn">Add Customer</button></a>
<a href="<%=request.getContextPath() %>/executiveController?action=account"><button class="btn1">Add Account</button></a>
</div>
